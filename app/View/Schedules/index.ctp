			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('freq'); ?></th>
				...
				<?php foreach ($schedules as $schedule): ?>
					<tr>
						...
						<td><?php echo h($schedule['Schedule']['code']); ?>&nbsp;</td>
						<td><?php echo h($schedule['Schedule']['description']); ?>&nbsp;</td>
						<td><?php echo h($schedule['Schedule']['startdate']); ?>&nbsp;</td>
						<td><?php echo h($schedule['Schedule']['enddate']); ?>&nbsp;</td>
						<td><?php echo h($schedule['Schedule']['freq']); ?>&nbsp;</td>
						<td><?php echo h($schedule['Schedule']['count']); ?>&nbsp;</td>
						<td><?php echo h($schedule['Schedule']['interval']); ?>&nbsp;</td>
						<td><?php echo h($schedule['Schedule']['runtime']); ?>&nbsp;</td>
						<td><?php echo h($schedule['Schedule']['legend']); ?>&nbsp;</td>
